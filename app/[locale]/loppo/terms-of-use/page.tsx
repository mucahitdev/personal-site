...
export const metadata: Metadata = {
  title: 'Loppo Terms of Use',
  description: 'Terms of Use for the Loppo iOS application.',
}

export default function LoppoTermsOfUsePage() {
  return (
    <main className="pb-10">
      <article className="space-y-6 text-sm leading-7 text-zinc-700 dark:text-zinc-300">
        ...
        <p>
          These Terms of Use govern your use of the Loppo mobile
          application. By using Loppo, you agree to these terms.
        </p>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              Loppo is provided for personal, lawful use to capture photos
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo requires camera, microphone, and photo library permissions
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo may display advertising provided by third parties such as
            Google AdMob. Your use of the app is subject to the privacy practices
            of those providers as described in our{' '}
            <Link className="underline" href="/loppo/privacy-policy">
              Privacy Policy
            </Link>
            . A Loppo Pro subscription removes ads.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>You agree not to use Loppo to:</p>
          <ul className="list-disc space-y-1 pl-5">
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo is provided &quot;as is&quot; and &quot;as available&quot; without warranties of
        ...
        <section className="space-y-2">
          ...
          <p>
            To the maximum extent permitted by law, Loppo and its developer
