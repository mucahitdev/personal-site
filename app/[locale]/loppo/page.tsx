...
export const metadata: Metadata = {
  title: 'Loppo',
  description: 'Loppo app overview, support, and legal links.',
}

export default function LoppoPage() {
  return (
    <main className="pb-10">
      <article className="space-y-8 text-sm leading-7 text-zinc-700 dark:text-zinc-300">
        <section className="space-y-3">
          ...
          <p>
            Loppo is an iOS camera app that lets you capture with two cameras
            at the same time. You can shoot photos or videos, reposition PiP,
            and save your results directly to your Photo Library.
          </p>
          <p>
            Built for fast content creation, Loppo focuses on an easy
