...
export const metadata: Metadata = {
  title: 'Loppo Privacy Policy',
  description: 'Privacy Policy for the Loppo iOS application.',
}

export default function LoppoPrivacyPolicyPage() {
  return (
    <main className="pb-10">
      <article className="space-y-6 text-sm leading-7 text-zinc-700 dark:text-zinc-300">
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">
            Loppo Privacy Policy
          </h1>
          <p>Effective date: June 28, 2026</p>
        </div>

        <p>
          Loppo is designed to record and capture content from multiple
          ...
          manage optional subscriptions, Loppo uses a small number of
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              Loppo does not require account creation and does not upload
              your media to a Loppo server.
            </li>
            <li>
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo uses Google Firebase (Analytics, Crashlytics, Performance,
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo may display ads through Google AdMob. To serve and measure
            ...
            . Where required, Loppo asks for your permission before using
            tracking identifiers, and you can change this at any time in iOS
            Settings. A Loppo Pro subscription removes ads.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo offers an optional premium upgrade (&quot;Loppo
          ...
          <p>
            ...
            your premium access, Loppo uses{' '}
            <a
              className="underline"
        ...
        <section className="space-y-2">
          ...
          <p>
            Loppo is not directed to children under 13, and we do not
        ...
        <p className="pt-2">
          <Link className="underline" href="/loppo/terms-of-use">
            Read Loppo Terms of Use
          </Link>
        </p>
      </article>
    </main>
